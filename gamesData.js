...
const games = [
 ...
 cardsEng: [
      {id: '1', text: "If you were a god, which song would play on repeat in heaven and in hell?",},
      {id: '2', text: "Would you never be able to eat meat or vegetables again?",},
      {id: '3', text: "Which Astrid Lindgren character are you most like?",},
      {id: '4', text: "Would you rather be physically paralyzed or emotionally paralyzed?",},
      {id: '5', text: "What is the best costume you've seen someone wear?",},
      {id: '6', text: "Which fear would you like to overcome?",},
      {id: '7', text: "Would you rather have a flying carpet or a car that can drive underwater?",},
      {id: '8', text: "What is the strangest thing you've eaten?",},
      {id: '9', text: "What is the weirdest allergy you've heard of?",},
      {id: '10', text: "Name one thing you would always like to carry with you.",},
      {id: '11', text: "Would you prefer to follow or lead a group?",},
      {id: '12', text: "Would you prefer to work alone or collaborate?", },
      {id: '13', text: "Would you rather have no one show up on your birthdays or at your funeral?",},
      {id: '14', text: "If you could live in a fictional world from a book or movie, which one would it be?",},
      {id: '15', text: "What do you prefer to do on a rainy day?",},
      {id: '16', text: "Have you ever performed in front of a large audience?",},
      {id: '17', text: "Would you rather get lost in a dangerous part of your city or lost in the woods?",},
      {id: '18', text: "When was the last time you learned something completely new (big or small)?",},
      {id: '19', text: "In a post-apocalyptic world, what skill or specialized knowledge would you contribute?",},
      ...
      {id: '23', text: "Have you ever dated someone who didn't speak the same language as you?"},
      {id: '24', text: "Which hour of the day do you think is the best?",},
      {id: '25', text: "Name a criminal act that you have committed."},
      {id: '26', text: "Describe a person who is your complete opposite in three words."},
      {id: '27', text: "What's your favourite creative thing to do?"},
      {id: '28', text: "Name something you haven't done yet but is on your bucket list.",},
      {id: '29', text: "How do you think your life will be in 10 years from now?"},
      {id: '30', text: "Are you the type to cry during sad movies?"},
      {id: '31', text: "Tell us about a time when you were extremely nervous."},
